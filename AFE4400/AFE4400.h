...
#ifndef AFE4400_AFE4400_H_
#define AFE4400_AFE4400_H_
...
#define    SPI_READ     (0x000001ul)        //SPI read				:BIT0
#define    TIM_CNT_RST  (0x000002ul)        //Timer counter reset	:BIT1
#define    DIAG_EN      (0x000004ul)        //Diagnostic enable		:BIT2
#define    SW_RST       (0x000008ul)        //Software reset		:BIT3
...
#define PRPCOUNT        0x1D							// 500HZ - 7999
#define PRP             ((AFECLK/PRF)-1)                // for 100HZ - 39999

#define DELTA           (((PRP+1)*DUTYCYCLE)/100)       // for 100HZ - 8000			500HZ - 125
#define CONV_DELTA      ((PRP+1)/4)                     // for 100HZ - 10000		500HZ -
